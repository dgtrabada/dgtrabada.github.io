...
* **No leas las notas**
* **Entretener**. Las presentaciones deben ser entretenidas e informativas. No es cuestión de montar un espectáculo, pero una exposición seca hará que la gente se aburra y por lo tanto preste menos atención.
...
* **Contacto visual**. Mira al público, no a la pantalla. Es fundamental mantener contacto visual con el auditorio, pero no centrarse en una sola persona (se puede sentir incómoda), debemos repartir nuestra mirada por todo el auditorio sin que sea molesto. Miramos a una persona y pronunciamos algunas frases, luego a otra, etc.
* **Realizar preguntas sin esperar que el auditorio las conteste**. Al utilizar este recurso, despertamos expectación y nos da tiempo para organizar tu respuesta.
