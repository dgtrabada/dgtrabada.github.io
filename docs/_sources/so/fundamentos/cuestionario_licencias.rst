...
.. cuestionario::
   ...
   4. Creative Commons:
      - 1. ¿Qué indica la condición "Reconocimiento (BY / Attribution)"?
        ...
        ( ) La obra no se puede modificar
      - 2. ¿Qué indica la condición "No Comercial (NC / Non commercial)"?
      ...
      - 4. ¿Qué indica la condición "Compartir Igual (SA / Share alike)"?
        ( ) La obra debe distribuirse gratuitamente
        (x) Las obras derivadas deben mantener la misma licencia al ser divulgadas
        ( ) No se pueden hacer obras derivadas
      - 5. ¿Qué condición está presente en todas las licencias Creative Commons?
        ( ) No Comercial (NC)
        ( ) Compartir Igual (SA)
        (x) Reconocimiento (BY)
      ...
      - 6. ¿Cuál es la licencia Creative Commons más permisiva?
        ...
        ( ) CC by-nc
        ( ) CC by-nc-nd
      - 7. ¿Cuál es la licencia Creative Commons más restrictiva?
        ( ) CC by-nd
        ( ) CC by-nc-sa
        (x) CC by-nc-nd
        ( ) CC by
      - 8. Si una obra es CC by-sa, sus obras derivadas
        ( ) pueden distribuirse con cualquier licencia
        (x) deben distribuirse con una licencia igual a la que regula la obra original
        ( ) no están permitidas
      - 9. ¿Qué licencia CC permite el uso comercial de la obra pero no la generación de obras derivadas?
        ( ) CC by-nc
        ( ) CC by-sa
        (x) CC by-nd
        ( ) CC by-nc-nd
      - 10. ¿Pueden combinarse las condiciones ND y SA en una misma licencia CC?
        (x) No, son incompatibles: SA exige que las derivadas mantengan la licencia y ND prohíbe las derivadas
        ( ) Sí, por ejemplo en la licencia CC by-nd-sa
