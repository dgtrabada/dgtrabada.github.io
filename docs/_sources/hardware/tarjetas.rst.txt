...
.. image:: tarjetas/tarjeta_graf1.png
.. image:: tarjetas/tarjeta_graf2.png
  :width: 400

.. image:: tarjetas/tarjeta_graf2.jpeg
...
* **Resolución**: Número de píxeles que es capaz de representar una tarjeta de vídeo en la pantalla tanto en horizontal como en vertical, ejemplo: Resolución de 800x600.
  ...
  .. image:: tarjetas/tamaño.png

  .. image:: tarjetas/tamaño2.png
    :width: 400
...
* **DisplayPort** es una alternativa al HDMI que fue desarrollado entre 2006 y 2007. Puedes diferenciarlo porque uno de los lados es diferente al otro. No es compatible con tantos dispositivos como el HDMI, pero tiene unas cualidades mayores. Podríamos decir que es una especie de evolución, el estándar heredero que sin ser tan soportado, aunque tiene un arma secreta que es la compatibilidad con puertos USB de tipo C.
  ...
  .. image:: tarjetas/displayport.png
    :width: 100
  .. image:: tarjetas/displayportf.png
    :width: 100

Tarjetas de sonido
==================

.. image:: tarjetas/sonido.png
...
+-----------+--------------------------------------------------------------------------------+
|           |(que algunas veces es utilizado como salida analógica para altavoces centrales).|
+-----------+--------------------------------------------------------------------------------+


* **Entrada / Salida digital SPDIF óptica**

  .. image:: tarjetas/spidf.png
    :width: 200

* **Entrada/Salida digital SPDIF coaxial**

  .. image:: tarjetas/spidf_coaxial.png
    :width: 200
...
* **Sonido envolvente** : Los sistemas más usados son Dolby Porlogic Surround, Dolby Digital AC-3 y DTS.
  ...
  .. image:: tarjetas/dolby.png

Tarjeta de red (PCI, PCMIA, INALÁMBRICAS)
========================================

.. image:: tarjetas/red.png
  :width: 300
.. image:: tarjetas/red2.png
  :width: 300
.. image:: tarjetas/pcmia.png
  :width: 300
.. image:: tarjetas/wifi.png
  :width: 300

Tarjetas sintonizadores de televisión.
======================================

.. image:: tarjetas/TV.png
...
.. image:: tarjetas/x1.png
  :width: 300
.. image:: tarjetas/x2.png
  :width: 300
.. image:: tarjetas/x3.png
  :width: 300
.. image:: tarjetas/x4.png
  :width: 300
.. image:: tarjetas/x5.png
  :width: 300
.. image:: tarjetas/x6.png
  :width: 300
.. image:: tarjetas/x7.png
  :width: 300

Controladoras RAID
------------------

.. image:: tarjetas/raid.png
  :width: 300
